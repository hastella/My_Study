...
const categories = [
  {
    id: 'web-basics',
    name: 'Web 기본 개념',
    description: '인터넷과 웹의 기초부터 브라우저 동작 원리까지 웹의 근본적인 개념들을 다룹니다.',
    icon: '🌐',
  ...
  },
  {
    id: 'html-css',
    name: 'HTML/CSS',
    description: '웹 페이지의 구조를 만들고 아름다운 디자인을 적용하는 방법을 학습합니다.',
    icon: '🎨',
  ...
  },
  {
    id: 'javascript',
    name: 'JavaScript',
    description: '프론트엔드 개발의 핵심 언어로 동적인 웹 페이지를 만들 수 있는 기술을 익힙니다.',
    icon: '⚡',
  ...
  },
  {
    id: 'react',
    name: 'React',
    description: '현대적인 UI 라이브러리로 컴포넌트 기반의 효율적인 웹 애플리케이션을 개발합니다.',
    icon: '⚛️',
  ...
  },
  {
    id: 'vue',
    name: 'Vue.js',
    description: '직관적이고 배우기 쉬운 프론트엔드 프레임워크로 빠른 개발을 경험해보세요.',
    icon: '🟢',
