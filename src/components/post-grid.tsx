      ...
      {posts.map((post, index) => (
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <span className={`px-3 py-1 text-xs font-semibold text-white rounded-full ${getCategoryColor(post.categories)}`}>
          ...
          <Link href={post.slug === '2026-01-13-typescript-기초부터-고급까지' ? '/blog/typescript-basics' : `/blog/${post.slug}`}>
